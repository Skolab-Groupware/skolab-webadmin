...
<div class="align_center">
 <a href="http://kolabsys.com/">
  <img src="{$webserver_web_prefix}/images/kolabsystems_logo.png" alt="Kolab Systems AG" longdesc="http://kolabsys.com" style="border:0px;" />
 </a>
</div>
<div class="contentsimple">
<p>
{t}Founded in Z&uuml;rich in 2010, {/t}<a href="http://kolabsys.com">Kolab Systems AG</a> {t}is the global leader in Kolab Technology. Together with its partners in the Kolab Enterprise Community, Kolab Systems provides quality assurance, integration, support, training, certification of individuals and third-party products, as well as ongoing development for the Kolab Groupware Solution. The strong partnering model and a highly competent enterprise community provides users of the Kolab Groupware Solution with the right level of professional consulting, support and warranties to enable productivity and collaboration.{/t}
</p>
...
<p>{t}In continuously improvingall parts of the Kolab Groupware Solution, Kolab Systems is working closely with development partners, such as (in alphabetical order):{/t}</p>
...
<p><b>{t}Thank you for being part of this awesome community!{/t}</b></p>

<p>{t}If <b>you</b> want to join the community, please go to {/t} <a href="http://kolab.org">kolab.org</a> {t}and{/t} <a href="http://wiki.kolab.org">wiki.kolab.org</a>.
