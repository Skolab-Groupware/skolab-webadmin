...
<input type="text" name="systemaliasmail_{$systemaliasconf[id].n}" size="80"  value="{$systemaliasmail[id]|escape:"html{/t}" /><br/>
...
<div>
<br />
{t}Warn users when they have used{/t} <input name="quotawarn" size="3"  value="{$quotawarn|escape:"html{/t}" /> {t}% of their quota{/t}<br />
...
<div>
<br />
{t}When creating free/busy lists, include data from{/t} <input name="freebusypast" size="3"  value="{$freebusypast|escape:"html{/t}" /> {t}days in the past{/t}<br />
...
<input type="text" name="postfixmynetworks" size="80"  value="{$postfixmynetworks|escape:"html{/t}" />
...
<input type="text" name="postfixrelayhost" size="40"  value="{$postfixrelayhost|escape:"html{/t}" />:
<input type="text" name="postfixrelayport" size="4" value="{$postfixrelayport|escape:"html{/t}" /><br/>
...
{section name=id loop=$postfixmydestination}
	...
	<tr class="contentrow{cycle values="even,odd{/t}">
	   <td class="contentcell">{$postfixmydestination[id]|escape:"html{/t}</td>
...
{section name=id loop=$kolabhost}
	<form method="post" action="">
	<tr class="contentrow{cycle values="even,odd{/t}">
	   <td class="contentcell">{$kolabhost[id]|escape:"html{/t}</td>
	   <td class="actioncell">{strip}
